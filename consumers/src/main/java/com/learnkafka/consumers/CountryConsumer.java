...
public class CountryConsumer {
    ...
    public CountryConsumer(Map<String, Object> propsMap){
    ...
    public static Map<String, Object> buildConsumerProperties() {
        ...
        propsMap.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, CountryDeserializer.class.getName());
        propsMap.put(ConsumerConfig.GROUP_ID_CONFIG, "countryConsumer");
   ...
   public void pollKafka(){
    ...
    public static void main(String[] args) {
        ...
        CountryConsumer messageConsumer = new CountryConsumer(propsMap);
